        ...
        <>
                    ...
                    items.slice(0, itemCount).map((item, index) => (
                        ...
                        >
                            ...
                            <div className="card cursor-pointer rounded-lg">
                                <div className="w-full overflow-hidden rounded-tr-lg rounded-tl-lg flex items-center bg-[var(--secondaryColor)]">
                                    <LazyLoadImage
                                        src={
                                ...
                                <div className="presentation p-1 md:p-2 justify-between flex flex-col lg:flex-row items-center text-center lg:text-start rounded-b-lg ">
            ...
            {hasMore && (
                <button
                    ...
                    className="m-auto mt-4 bg-[var(--secondaryColor)] hover:bg-[var(--secondaryColor)]text-sm text-white font-[100] py-2 px-4 rounded shadow-lg hover:shadow-xl transition duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-black-300 focus:ring-offset-2"
                >
                    Load More...
                </button>
            )}

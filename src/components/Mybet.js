        ...
        <div className="max-w-[1200px] m-auto w-full mt-[30px] px-4 md:px-0">
            <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex items-center">
                    ...
                    <button className="bg-red-900 hover:bg-red-700 text-white font-bold py-3 px-4 rounded">
                        Refresh
                    </button>
                </div>
            </div>
                    ...
                    <div className="overflow-x-auto relative shadow-md sm:rounded-lg mt-4">
                        <table className="w-full text-sm text-left">
                            <thead className="text-xs text-blue-100 uppercase">
                                <tr className="py-3 px-6 border-b-2 border-gray-600 bg-red-1200 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                                    <th scope="col">#</th>
                            ...
                            <tbody>
                                {currentBets.length < 0 ? (
                                    currentBets.map((bet, index) => (
                                        <tr className="text-[#000] border-b border-[#bbb]">
                                            <th
                                                scope="row"
                                            ...
                                            <td className="text-right py-4 px-6 text-[#000]">
                                                {bet.winAmount}
                                            </td>
                                        </tr>
                                    ))

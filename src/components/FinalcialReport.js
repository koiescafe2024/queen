        ...
        <div className="max-w-[1200px] m-auto w-full mt-[30px] px-4 md:px-0">
            <div className="flex justify-between items-center mb-4 ">
                ...
                <div className="flex items-center">
                    ...
                    />
                    <button
                        className="bg-red-800 hover:bg-black-700 text-white font-bold py-2 px-4 rounded"
                        ...
                        <table className="w-full text-sm text-left">
                            <thead className="text-xs text-[var(--textPrimaryColor)] uppercase">
                                <tr>
                                    <th
                                        scope="col"
                                        className="py-3 px-6 border-b-2 border-gray-800 bg-gray-1200 text-left text-xs font-bold uppercase tracking-wider text-black"
                                    >
                                        Date
                                    </th>
                                    <th

            ...
            <div className="overflow-x-auto relative sm:rounded-lg mt-4">
                <div className="flex flex-col md:flex-row w-full text-sm text-left gap-6">
                    <div className="w-full md:w-1/2">
                        <h3 className="text-lg text-black border-black border-b-[4px] mb-4 font-bold">
                            Profile
                        </h3>
                    ...
                    <div className="w-full md:w-1/2">
                        ...
                        <button
                            className=" text-white font-bold py-2 px-4 rounded float-right bg-[var(--secondaryColor)]"

...
export const Footer = () => {
    ...
    return (
        <footer className={`pt-16 mt-16`}>
            ...
            <div className="content-footer-area px-3 md:px-3 mx-auto bg-black">
                <div className="why-area grid lg:grid-cols-2 gap-6 lg:gap-36">
                    <div className="left-area-footer-why">
                        <h1 className="pt-10">{t("Why Queen Diamond?")}</h1>
                        <p className="mt-8">{t("The Widest Selection of Games. At Queen Diamond, we believe that variety is the spice of life. Whether you're a fan of casino games, a sports betting enthusiast, or simply looking for new challenges, we've got you covered. Our gaming hub is constantly updated with the latest and greatest offerings, from card games and slot machines, to competitive sports betting, and more!")}</p>
                        <p className="mt-4">{t("Interested in elevating your gaming and earning experience? Queen Diamond is offering you a golden opportunity you don't want to miss. Join our affiliate program and earn incredible commissions, up to a staggering 60%, along with enticing incentives and cashback rewards!")}</p>
                    ...
                    <div className="right-area-footer-why pt-10">
                        ...
                        <p>
                            {t("Or Email us: ")}
                            <a
                                href="mailto:queendiamond.community@gmail.com"
                                className="text-[#9e0505]"
                            >
                                queendiamond.community@gmail.com
                            </a>
                        </p>
                    </div>
                </div>
            ...
            <li>
              ...
              <img src={logo} alt='' />
                ...
                <div className="cols-footer-area mt-16 grid sm:grid-cols-2 md:grid-cols-3 gap-6">
                    <div className="col">
                        <h1>{t("Why Choose Queen Diamond Affiliate Program?")}</h1>
                        <p className="mt-7">
                ...
                <div className="copyright-area mt-20 pb-4 flex flex-col sm:flex-row gap-4 items-center justify-between">
                    <p>© 2024 Queen Diamond. {t("All rights reserved")}</p>

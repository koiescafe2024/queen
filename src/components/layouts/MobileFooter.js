...
const MobileFooter = () => {
    ...
    return (
        <>
            <div class="fixed bottom-0 left-0 right-0 h-16 bg-[var(--secondaryColor)]  flex md:hidden justify-around items-center z-50 rounded-[30px] m-2">
                {/* <div
                ...
                <div
                    ...
                    onClick={() => onPromotionHandler()}
                >
                    <img src={PromotionSVG} width={20} height={20} />
                    <span class="text-white text-xs font-medium mt-1 truncate max-w-full">
                        Home
                    </span>
                </div>
